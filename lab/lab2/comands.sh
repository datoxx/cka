6) 
#doc:  https://kubernetes.io/docs/reference/access-authn-authz/certificate-signing-requests/#normal-user
# extra doc simple:
https://yuminlee2.medium.com/kubernetes-generate-certificates-for-normal-users-using-certificates-api-7ba71170aa52#:~:text=The%20process%20of%20creating%20client,signed%20certificate%20to%20the%20user.
...
encrypt /root/CKA/john.csr for atribute request in CertificateSigningRequest:
